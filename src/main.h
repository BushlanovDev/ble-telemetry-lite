...
#define DEFAULT_BLE_DBM_LOW_PWR 3
#define DEFAULT_BLE_DBM_HIGH_PWR 9
#define DEFAULT_WEB_PORT 80
#define DEFAULT_TIMEOUT_MS 120000
#define DEFAULT_LINK_STATS_PACKET_PERIOD_MS 250
#define SERIAL_CONNECT_TIMEOUT_MS 5000
